...
impl ChainLinkBridge {
    ...
    pub fn add_feed_data(&self, symbol: String, proof: DataProof) -> Promise{
        ...
        require!(proof.eth_height - previous_data.eth_height >= self.min_block_delay_eth, "Should cross min block delay for eth");
